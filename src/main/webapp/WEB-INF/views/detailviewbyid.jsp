...
<%--    <br/>--%>
    ...
    <script>
        ...
        function toupdate(id){
            ...
            window.location.href ='/detailviewbyidupdate/'+id;
        }
        function tolist(){
            alert("목록으로 돌아갑니다.");
    ...
    <div id="bottbtnlist">
        <button onclick="toupdate(parseInt('${detail.id}'));" class="btn bglighblue">수정</button>
    ...
    <div class="writedt bglightgrey">
        <p> 댓글 쓰기</p>
        <form action="/registerdat/${detail.id}" method="post">
            ...
            <c:forEach items="${comments}" var="comment">
                ...
                <div class="dt" style="height: 130px;">
                    <ul style="float:right;margin-top: -20px;color:white; list-style: none; font-size:0.9em;display:inline-flex">
                        <li class="fred">
                            <a class="fred" href='"/updatedat/"+parseInt("${comment.id}")'>
                                수정&nbsp;
                            </a>
                        </li>|
                        <li >
                            <a class="fblue" href='"/deldat/"+parseInt("${comment.id}")'>
                                &nbsp;삭제
                            </a>
                        </li>
                    </ul>
